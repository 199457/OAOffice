...
public class CodeGenerator {
    ...
    // 数据库连接配置
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/yeb?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String JDBC_USER_NAME = "root";
    private static final String JDBC_PASSWORD = "root";

    // 包名和模块名
    private static final String PACKAGE_NAME = "com.wei";
    private static final String MODULE_NAME = "server";

    // 表名，多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {
            "t_admin", "t_admin_role", "t_appraise",
            "t_department", "t_employee", "t_employee_ec",
            "t_employee_remove", "t_employee_train", "t_job_level",
            "t_mail_log", "t_menu", "t_menu_role",
            "t_nation", "t_oplog", "t_politics_status",
            "t_position", "t_role", "t_salary",
            "t_salary_adjust", "t_sys_msg", "t_sys_msg_content"
    };
    ...
    public static void main(String[] args) {
        ...
        fastAutoGenerator.globalConfig(globalConfigBuilder -> globalConfigBuilder
                ...
                .outputDir(MODULE_NAME + "\\src\\main\\java")
                .author("ChenZhen")
